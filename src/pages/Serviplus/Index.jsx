...
function Accesorios() {
    document.title = 'Hard - Accesorios';
        ...
        <div className="container marketing">
          <div className="row mx-auto align-middle text-center py-4">
            <div className="col-lg-4 mx-auto">
              ...
              <p><Link to="https://wa.link/ytp17z" className="btn btn-secondary">Más info »</Link></p>
            </div>
            <div className="col-lg-4 mx-auto">
          ...
          <div className="row featurette">
            ...
            <div className="col-md-5">
              <img src={asesor} className="img-fluid mx-auto rounded" alt="Asesor" />
            </div>
          </div>
          <hr className="featurette-divider" />
          <div className="row featurette">
            ...
            <div className="col-md-5 order-md-1">
              <img src={repair} className="img-fluid mx-auto rounded" alt="Técnico" />
            </div>
          </div>
          <hr className="featurette-divider" />
          <div className="row featurette">
            ...
            <div className="col-md-5">
              <img src={smartnew} className="img-fluid mx-auto rounded" alt="Crédito" />
            </div>
          </div>
          <hr className="featurette-divider" />
