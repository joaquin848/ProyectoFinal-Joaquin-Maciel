    ...
    <article>
      ...
      <div className="px-4 py-2 my-5 text-center d-lg-none d-xl-none">
        ...
        <div className="col-lg-6 mx-auto">
          ...
          <a href='https://wa.link/ytp17z'><button type="button" className="btn btn-primary btn-lg px-4 gap-3">Más info</button></a>
      ...
      <div className="container col-xxl-8 px-4 py-2 d-none d-lg-block">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            ...
            <a href='https://wa.link/ytp17z'><button type="button" className="btn btn-primary btn-lg px-4 me-md-2">Más info</button></a>
              <Link to="/contacto"><button type="button" className="btn btn-outline-secondary btn-lg px-4">Contratar</button></Link>
            </div>
          </div>
        </div>
