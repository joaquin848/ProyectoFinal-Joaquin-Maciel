...
import tecnojimp from '../../assets/images/main_hardstore.png';
        ...
        <div className="container-lg max-w-screen-xl position-relative overlap-10 text-center text-lg-start pt-5 pb-5 pt-lg-6">
          <div className="row row-grid align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              ¡Explora la Vanguardia Tecnológica: Descubre Nuestra Colección de Productos Innovadores!
              </h1>
              
              <p className="lead text-white text-opacity-80 mb-10 w-lg-2/3">
              Potencia Tu Estilo de Vida con lo Último en Tecnología: Encuentra Productos que Transformarán tu Experiencia.
      ...
      <section>
        <article>
          <div className="px-4 py-2 my-5 text-center d-lg-none d-xl-none">
            ...
            <h1 className="display-5 fw-bold">¡Oferta tecnológica del mes!</h1>
            <div className="col-lg-6 mx-auto">
              <p className="lead mb-4">¡Bienvenido a Nuestra Tienda Tecnológica de Vanguardia!
               Donde la Innovación y el Estilo se Unen para Potenciar Tu Vida Digital. Explora Nuestra Colección de Productos Innovadores y Descubre una Experiencia Tecnológica Única.</p>
          ...
          <div className="container col-xxl-8 px-4 py-2 d-none d-lg-block">
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
              ...
              <div className="col-lg-6">
                <h1 className="display-5 fw-bold lh-1 mb-3">¡Oferta tecnológica del mes!</h1>
                <p className="lead">¡Bienvenido a Nuestra Tienda Tecnológica de Vanguardia!
                 Donde la Innovación y el Estilo se Unen para Potenciar Tu Vida Digital. Explora Nuestra Colección de Productos Innovadores y Descubre una Experiencia Tecnológica Única.</p>
            ...
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div className="card-bodyjimp rounded-bottom" >
                  ...
                  <Link to="/category/apple"><button type="button" className="w-100 btn btn-lg btn-primary">¡Compra Online!</button></Link>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div className="card-bodyjimp rounded-bottom">
                  ...
                  <Link to="/category/samsung"><button type="button" className="w-100 btn btn-lg btn-primary">¡Compra Online!</button></Link>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div className="card-bodyjimp rounded-bottom">
                  ...
                  <Link to="/category/accesorios"><button type="button" className="w-100 btn btn-lg btn-primary">¡Compra Online!</button></Link>
                </div>
              </div>
            </div>
          </div>
